...
const schema = computed(() =>
    z.object({
        ...
        password: z
            .string({ message: t("auth.form.errors.password.required") })
        ...
        <div class="flex flex-col gap-2">
            ...
            >
                ...
                <input
                    ...
                    v-bind="pseudoAttrs"
                    v-model="pseudo"
                    :placeholder="t('auth.form.inputs.pseudo.placeholder')"
                />
            </label>
        </div>
        <div class="flex flex-col gap-2">
        ...
        <div class="flex flex-col gap-3">
            ...
            >
                ...
                <span @click="handleViewPassword">
                    <v-icon name="fa-regular-eye-slash" v-if="showPassword" />
                    <v-icon v-else name="fa-regular-eye" />
                </span>
            </label>
